...
public abstract class LoggerHelper {
    ...
    // intenal is different
    private static final String         DEFAULT_MORE_URL   = LoggerConfig.MORE_INFO_URL + "help/";
...
//                throw new RuntimeException("-DJM.LOG.PATH must be an absolute path.");
    ...
    public static String getErrorCodeStr(String errorCode) {
        return "ERR-CODE: [" + errorCode + "], More: [" + LoggerConfig.MORE_INFO_URL + "jm/" + errorCode + "]";
    }
