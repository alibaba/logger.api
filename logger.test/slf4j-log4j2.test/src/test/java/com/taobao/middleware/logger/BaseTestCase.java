...
public abstract class BaseTestCase {
    ...
    public void testDebug() {
        ...
        AssertUtils.assertContain("this is " + getLogImpl() + " debug info @ ",
    ...
    public void testInfo() {
        ...
        Date now = new Date();
        logger.info("1", format, now);
        AssertUtils.assertContain("this is " + getLogImpl() + " info info @ ",
                                  AssertUtils.readNewLine(LoggerHelper.getLogFileP(productName, file)));
    ...
    public void testWarn() {
        ...
        Date now = new Date();
        logger.warn("1", format, now);
        AssertUtils.assertContain("this is " + getLogImpl() + " warn info @ ",
                                  AssertUtils.readNewLine(LoggerHelper.getLogFileP(productName, file)));
    ...
    public void testError() {
        ...
        AssertUtils.assertContain("this is " + getLogImpl() + " error info @ ",
                                  AssertUtils.readNewLine(LoggerHelper.getLogFileP(productName, file)));
        AssertUtils.assertContain(",just a param",
                AssertUtils.readNewLine(LoggerHelper.getLogFileP(productName, file)));
        ...
        // 验证warn带context和异常
        logger.error("loginId=error002", productName.toUpperCase() + "-0002",
                     "this is " + getLogImpl() + " error info @ " + new Date().toString(),
                     new IllegalArgumentException("just test"));
